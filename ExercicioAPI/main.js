...
let arma = {
    dano: {
        physical: 0, magic: 0, lightning: 0, fire: 0
    },
    requirimentos: {
        faith: 14, strength: 10, intelligence: 0, dexterity: 10
    }
}
...
window.onload = () => {
    ...
    document.getElementById("sorcerer").onclick = () => selecionaClasse("Sorcerer");
    document.getElementById("pyromancer").onclick = () => selecionaClasse("Pyromancer");
    document.getElementById("deprived").onclick = () => selecionaClasse("Deprived");
